...
<div class="team-container">
  ...
  <div class="member-card">
    <img src="images/longyan.jpg" alt="Longyan Ding" />
    <h4>Longyan Ding (丁龙艳)</h4>
    <p>Research Assistant</p>
    <p><a href="mailto:dinglongyan@westlake.edu.cn">dinglongyan@westlake.edu.cn</a></p>
  </div>
...
<div class="member-card">
   ...
   <div class="member-card">
    <img src="images/yjt1.jpg" alt="Junting Ye" />
   ...
   <div class="member-card">
    <img src="images/zichang.jpg" alt="Zichang Lin" />
    <h4>Zichang Lin (林子畅)</h4>
    <p>Visiting Student</p>
    <p><a href="mailto:linzichang@westlake.edu.cn">linzichang@westlake.edu.cn</a></p>
  </div>
  </div>
...
<div style="margin-top: 60px;">
  ...
  <table style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
      ...
      <tr style="border-bottom: 1px solid #eee;">
        <td style="padding: 10px;">Wenhui Tao</td>
        <td style="padding: 10px;">2025.3-2026.5</td>
        <td style="padding: 10px;">Research Assistant</td>
      </tr>
    </tbody>
  </table>
</div>
